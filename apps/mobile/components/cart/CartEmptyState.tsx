...
const perks = [
  { icon: 'flash-outline' as const, label: 'Швидке оформлення' },
  { icon: 'shield-checkmark-outline' as const, label: 'Якісні аксесуари' },
  { icon: 'car-outline' as const, label: 'Доставка по Україні' },
];

export function CartEmptyState({ onBrowseCatalog, onGoHome }: Props) {
  return (
    <View style={styles.card}>
      ...
      <Text style={styles.title}>Поки тут порожньо</Text>
      <Text style={styles.text}>
        Оберіть чохли, захист екрану чи інші аксесуари для iPhone — і додайте їх
        у кошик в один дотик.
      </Text>
